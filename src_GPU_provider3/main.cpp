...
string Name_sharedmemory="ShareMemory3";
string Name_Mutex="Mutex3";
string Name_BmpRdyEvent="BmpRdyEvent3";
string Name_MouseEvent="MouseEvent3";
...
int main(  int argc, char **argv  )
{
  ...
  glutCreateWindow( "GPU provider3" );
  glewInit();
  getGLinfo();
  init(fname);
