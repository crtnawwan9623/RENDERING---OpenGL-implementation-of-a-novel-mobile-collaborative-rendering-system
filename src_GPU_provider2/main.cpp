...
string Name_sharedmemory="ShareMemory2";
string Name_Mutex="Mutex2";
string Name_BmpRdyEvent="BmpRdyEvent2";
string Name_MouseEvent="MouseEvent2";
...
int main(  int argc, char **argv  )
{
  ...
  glutCreateWindow( "GPU provider2" );
  glewInit();
  getGLinfo();
  init(fname);
